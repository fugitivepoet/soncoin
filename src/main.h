...
static const int64 MAX_MONEY = 7777000 * COIN; // SonCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 2) / 250; // SonCoin: Priority cutoff is 2 SonCoin day / 250 bytes.
    }
